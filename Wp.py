...
class InputDlg(QDialog):
    def __init__(self,parent=None):  
        ...
        layout.addWidget( self.text_edit,1,0,3,0) 
        self.setLayout(layout)  
        self.setWindowTitle("Model: Wp")
        self.setWindowIcon(QIcon('shao5.jpg'))
    def OnOk( self ):
        N=int(self.textField1.text())
        wn = []
        for i in range(N):
            numb,ok=QInputDialog.getText(self,self.tr("Wprojection"),self.tr("please enter the "+str(i+1)+"st number :"),QLineEdit.Normal,self.text_edit.toPlainText())  
        ...
        self.text_edit.setText("your enter numbers are   "+str(wn))
